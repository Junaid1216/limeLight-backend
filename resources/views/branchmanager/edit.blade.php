    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                <a class="btn btn-primary mb-3" href="{{ url('admin/branch-manager') }}">Back</a>

                <form id="edit_farmer" action="{{ route('branch.manager.update', $branchmanager->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <h4 class="text-center my-4">Edit Branch Manager</h4>
                                <div class="row mx-0 px-4">
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group">
                                            <label for="employee_id">Employee Id <span style="color: red;">*</span></label>
                                            <input type="text" class="form-control @error('employee_id') is-invalid @enderror"
                                                id="employee_id" name="employee_id" value="{{ old('employee_id', $branchmanager->employee_id) }}"
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                id="name" name="name" value="{{ old('name', $branchmanager->name) }}"
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                                id="email" name="email" value="{{ old('email', $branchmanager->email) }}"
                                                ...
                                                <select class="form-control @error('branch_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($branches as $branch)
                                                        <option value="{{ $branch->id }}"
                                                            {{ old('branch_id', $branchmanager->branch_id) == $branch->id ? 'selected' : '' }}>
                                                            {{ $branch->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select class="form-control @error('designation_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($designations as $designation)
                                                        <option value="{{ $designation->id }}"
                                                            {{ old('designation_id', $branchmanager->designation_id) == $designation->id ? 'selected' : '' }}>
                                                            {{ $designation->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            @if ($branchmanager->image)
                                                <div class="mt-2">
                                                    <img src="{{ asset($branchmanager->image) }}" width="100">
                                                </div>
                                            @endif
                                            @error('image')
                                                <div class="invalid-feedback">{{ $message }}</div>
